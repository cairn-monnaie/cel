...
class User extends BaseUser
{
    ...
    public function isUserValid(ExecutionContextInterface $context)
    {
        ...
        if(!preg_match('#^[a-z0-9._-]+@[a-z0-9._-]{2,}\.[a-z]{2,3}$#',$this->getEmail())){
            $context->buildViolation("Email invalide. Ne contient ni majuscule ni accent.Le symbole @ est suivi d\'au moins 2 chiffres/lettres, et le point de 2 ou 3 lettres.")
                ->atPath('email')
                ->addViolation();
        }
