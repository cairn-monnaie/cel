 ...
 */
class Banknote extends \Cairn\UserBundle\Entity\Banknote implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Cairn\\UserBundle\\Entity\\Banknote' . "\0" . 'id', '' . "\0" . 'Cairn\\UserBundle\\Entity\\Banknote' . "\0" . 'number', '' . "\0" . 'Cairn\\UserBundle\\Entity\\Banknote' . "\0" . 'value', '' . "\0" . 'Cairn\\UserBundle\\Entity\\Banknote' . "\0" . 'status', '' . "\0" . 'Cairn\\UserBundle\\Entity\\Banknote' . "\0" . 'lastUpdate'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Banknote $proxy) {
