 ...
 */
class User extends \Cairn\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'name', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'cyclosID', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'address', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'description', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'creationDate', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'referents', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'beneficiaries', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'image', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'card', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'nbCards', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'passwordTries', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'cardKeyTries', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'rib', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
     ...
     * {@inheritDoc}
     */
    public function isUsernameValid(\Symfony\Component\Validator\Context\ExecutionContextInterface $context)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isUsernameValid', [$context]);

        return parent::isUsernameValid($context);
    }

    /**
     * {@inheritDoc}
     */
    public function isUserValid(\Symfony\Component\Validator\Context\ExecutionContextInterface $context)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isUserValid', [$context]);

        return parent::isUserValid($context);
    }
    ...
    public function setCyclosID($cyclosID)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCyclosID', [$cyclosID]);

        return parent::setCyclosID($cyclosID);
    }
    ...
    public function getCyclosID()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCyclosID', []);

        return parent::getCyclosID();
    }
    ...
    public function fromEntityToDTO()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'fromEntityToDTO', []);

        return parent::fromEntityToDTO();
    }
    ...
    public function hasBeneficiary(\Cairn\UserBundle\Entity\Beneficiary $testBeneficiary)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasBeneficiary', [$testBeneficiary]);

        return parent::hasBeneficiary($testBeneficiary);
    }
    ...
    public function setPasswordTries($passwordTries)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPasswordTries', [$passwordTries]);

        return parent::setPasswordTries($passwordTries);
    }
    ...
    public function getPasswordTries()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPasswordTries', []);

        return parent::getPasswordTries();
    }
    ...
    public function setCardKeyTries($cardKeyTries)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCardKeyTries', [$cardKeyTries]);

        return parent::setCardKeyTries($cardKeyTries);
    }
    ...
    public function getCardKeyTries()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCardKeyTries', []);

        return parent::getCardKeyTries();
    }
    ...
    public function setNbCards($nbCards)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNbCards', [$nbCards]);

        return parent::setNbCards($nbCards);
    }
    ...
    public function getNbCards()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNbCards', []);

        return parent::getNbCards();
    }
    ...
    public function hasReferent(\Cairn\UserBundle\Entity\User $referent)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'hasReferent', [$referent]);

        return parent::hasReferent($referent);
    }
    ...
    public function setSingleReferent(\Cairn\UserBundle\Entity\User $referent = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSingleReferent', [$referent]);

        return parent::setSingleReferent($referent);
    }
    ...
    public function getSingleReferent()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSingleReferent', []);

        return parent::getSingleReferent();
    }
    ...
    public function addReferent(\Cairn\UserBundle\Entity\User $referent)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addReferent', [$referent]);

        return parent::addReferent($referent);
    }
    ...
    public function removeReferent(\Cairn\UserBundle\Entity\User $referent)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeReferent', [$referent]);

        return parent::removeReferent($referent);
    }
    ...
    public function getReferents()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getReferents', []);

        return parent::getReferents();
    }
