...
class User extends \Cairn\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'name', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'cyclosID', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'address', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'description', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'creationDate', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'referents', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'beneficiaries', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'image', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'card', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'nbCards', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'passwordTries', '' . "\0" . 'Cairn\\UserBundle\\Entity\\User' . "\0" . 'cardKeyTries', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
