    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/re')) {
            ...
            if (0 === strpos($pathinfo, '/register/informations')) {
                ...
                if (preg_match('#^/register/informations/(?P<type>[^/]++)/?$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'fos_user_registration_register')), array (  '_controller' => 'fos_user.registration.controller:registerAction',));
                }
                not_fos_user_registration_register:

                // fos_user_registration_check_email
                if (preg_match('#^/register/informations/(?P<type>[^/]++)/check\\-email$#s', $pathinfo, $matches)) {
                    if ('GET' !== $canonicalMethod) {
                        $allow[] = 'GET';
                        goto not_fos_user_registration_check_email;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'fos_user_registration_check_email')), array (  '_controller' => 'fos_user.registration.controller:checkEmailAction',));
                }
                not_fos_user_registration_check_email:

                // fos_user_registration_confirm
                if (preg_match('#^/register/informations/(?P<type>[^/]++)/confirm/(?P<token>[^/]++)$#s', $pathinfo, $matches)) {
                    if ('GET' !== $canonicalMethod) {
                        $allow[] = 'GET';
                ...
                if (preg_match('#^/register/informations/(?P<type>[^/]++)/confirmed$#s', $pathinfo, $matches)) {
                    if ('GET' !== $canonicalMethod) {
                        $allow[] = 'GET';
                        goto not_fos_user_registration_confirmed;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'fos_user_registration_confirmed')), array (  '_controller' => 'fos_user.registration.controller:confirmedAction',));
                }
        ...
        if (0 === strpos($pathinfo, '/user')) {
            ...
            if (0 === strpos($pathinfo, '/user/referent/assign') && preg_match('#^/user/referent/assign/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
                if (substr($pathinfo, -1) !== '/') {
            ...
            if (0 === strpos($pathinfo, '/user/profile/view') && preg_match('#^/user/profile/view/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
                if (substr($pathinfo, -1) !== '/') {
            ...
            if (0 === strpos($pathinfo, '/user/beneficiaries')) {
                ...
                if (0 === strpos($pathinfo, '/user/beneficiaries/edit') && preg_match('#^/user/beneficiaries/edit/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
                    if (substr($pathinfo, -1) !== '/') {
                ...
                if (0 === strpos($pathinfo, '/user/beneficiaries/remove') && preg_match('#^/user/beneficiaries/remove/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
                    if (substr($pathinfo, -1) !== '/') {
        ...
        if (0 === strpos($pathinfo, '/card')) {
            ...
            if (0 === strpos($pathinfo, '/card/home') && preg_match('#^/card/home/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
                if (substr($pathinfo, -1) !== '/') {
            ...
            // cairn_user_card_new
            if (0 === strpos($pathinfo, '/card/new') && preg_match('#^/card/new/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
                if (substr($pathinfo, -1) !== '/') {
            ...
            if (0 === strpos($pathinfo, '/card/revoke') && preg_match('#^/card/revoke/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
                if (substr($pathinfo, -1) !== '/') {
            ...
            if (0 === strpos($pathinfo, '/card/download') && preg_match('#^/card/download/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'cairn_user_card_download')), array (  '_controller' => 'Cairn\\UserBundle\\Controller\\CardController::downloadCardAction',));
            }
        ...
        elseif (0 === strpos($pathinfo, '/banking')) {
            if (0 === strpos($pathinfo, '/banking/download')) {
                ...
                if (0 === strpos($pathinfo, '/banking/download/rib') && preg_match('#^/banking/download/rib/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
                    if (substr($pathinfo, -1) !== '/') {
                ...
                if (0 === strpos($pathinfo, '/banking/download/notice') && preg_match('#^/banking/download/notice/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
                    if (substr($pathinfo, -1) !== '/') {
            ...
            if (0 === strpos($pathinfo, '/banking/transaction')) {
                ...
                if (0 === strpos($pathinfo, '/banking/transaction/recurring/cancel') && preg_match('#^/banking/transaction/recurring/cancel/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
                    if (substr($pathinfo, -1) !== '/') {
                ...
                if (0 === strpos($pathinfo, '/banking/transaction/scheduled/edit') && preg_match('#^/banking/transaction/scheduled/edit/(?P<id>[^/\\.]++)\\.(?P<status>cancel|open|block)/?$#s', $pathinfo, $matches)) {
                    if (substr($pathinfo, -1) !== '/') {
                ...
                if (0 === strpos($pathinfo, '/banking/transactions/recurring/view/detailed') && preg_match('#^/banking/transactions/recurring/view/detailed/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
                    if (substr($pathinfo, -1) !== '/') {
                ...
                if (0 === strpos($pathinfo, '/banking/transactions/recurring/occurrence/execute') && preg_match('#^/banking/transactions/recurring/occurrence/execute/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
                    if (substr($pathinfo, -1) !== '/') {
            ...
            if (0 === strpos($pathinfo, '/banking/transfer/view') && preg_match('#^/banking/transfer/view/(?P<type>scheduled.past|scheduled.futur|recurring|simple)\\-(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
                if (substr($pathinfo, -1) !== '/') {
            ...
            if (0 === strpos($pathinfo, '/banking/accounts/overview') && preg_match('#^/banking/accounts/overview/(?P<id>[^/]++)/?$#s', $pathinfo, $matches)) {
                if (substr($pathinfo, -1) !== '/') {
